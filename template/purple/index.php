      ...
      <div class="modal-dialog">
        <div class="modal-content">
          <div class="block block-themed block-transparent remove-margin-b">
            ...
            <div class="table-responsive " style="height:403px; overflow:scroll; overflow-x:hidden;">
	...
	<ul class="list-group animated bounceIn">
      <li class="list-group-item">
		...
		<div class="col-xs-12 well well-sm animation-pullUp" <?php if(empty($conf['gg_search'])){?>style="display:none;"<?php }?>><?php echo $conf['gg_search']?></div>
			...
			<input type="submit" id="submit_query" href="#query_order" target="_blank" data-toggle="modal" class="btn btn-sm btn-success btn-block btn-sm" style="text-shadow: black 1px 1px 1px;" value="查询订单">
			<br/>
   </div>
<!--查询订单-->
<!--开通分站-->
