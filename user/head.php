...
<head>
  ...
  <link rel="stylesheet" href="<?php echo $cdnserver?$cdnserver:'../';?>assets/user/css/animate.css" type="text/css" />
  <link rel="stylesheet" href="<?php echo $cdnserver?$cdnserver:'../';?>assets/user/css/app.css" type="text/css" />
