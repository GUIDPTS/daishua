...
<?php
	...
	$sitename=daddslashes(trim(htmlspecialchars(strip_tags($_POST['sitename']))));
	$title=daddslashes(trim(htmlspecialchars(strip_tags($_POST['title']))));
	$keywords=daddslashes(trim(htmlspecialchars(strip_tags($_POST['keywords']))));
	$description=daddslashes(trim(htmlspecialchars(strip_tags($_POST['description']))));
